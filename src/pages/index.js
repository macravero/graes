...
const IndexPage = () => {
  ...
  <Layout>
    ...
    <div className={styles.container}>
      ...
      <Link to='/causas' className={styles.link}>DESCUBRA MÁS</Link>
      </div>
      <div className={styles.sectionFive}>
        ...
        <Link to='/servicios' className={styles.link}>VER TODOS</Link>
      </div>
      ...
      <div className={styles.sectionSix}>
        ...
        <Link to='/covid19' className={styles.link}>VER IMPACTO</Link>
      </div>
      <Aliados/>
    </div>
  </Layout>
